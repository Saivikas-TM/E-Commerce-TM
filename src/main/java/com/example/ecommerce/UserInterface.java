...
public class UserInterface {
    ...
    GridPane loginPage;//they form a grid of rows and columns.
    HBox headerBar;//HBox layout pane arranges the nodes in a single row.
    HBox footerBar;
    Button signInButton;
    Label welcomeLabel;
    VBox body;
    ...
    public BorderPane creatContent() {
        //if we use BorderPane we can set components left,right,center,top & down.
    ...
    public UserInterface() {//this is a constructor
    ...
    private void creatLoginPage() {
        ...
        Text userNameText = new Text("User Name");//it will show this on the login page
        Text passwordText = new Text("Password");

        TextField userName = new TextField("vishwagnavikassai@gmail.com");//textfield creats box to enter text.
        userName.setPromptText("Type your user name here");
        PasswordField password = new PasswordField();/*enables users of a JavaFX application to enter password
        which can then be read by the application. The PasswordField control does not show the texted
        entered into it. Instead it shows a circle for each character entered.*/
        password.setText("abc123");
        password.setPromptText("Type your password here");
        Label messageLabel = new Label("Hi");


        Button loginButton = new Button("Login");//creating button
/*This is a button class, it performs a task if it clicked by mouse or if u tap*/
        ...
        loginPage.add(loginButton, 1, 2);//adding button
